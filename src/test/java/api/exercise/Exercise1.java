...
public class Exercise1 {
    ...
    public void acceptGreaterThan21OthersDecline() {
        ...
        Predicate<Person> isOlderThan21 = p -> p.getAge() > 21;
    ...
    public void getStatus() {
        ...
        Status ivanStatus = candidates.getOrDefault(alex, Status.UNKNOWN);
        Status helenStatus = candidates.getOrDefault(alex, Status.UNKNOWN);
