...
public class Exercise1 {
    ...
    public void mapEmployeesToLengthOfTheirFullNames() {
        ...
        Function<String, Integer> stringIntegerExtractor = String::length;

        // TODO функция извлечения длины полного имени из сотрудника fullNameLengthExtractor: Employee -> Integer
        Function<Employee, Integer> fullNameLengthExtractor = personExtractor.andThen(
                fullNameExtractor.andThen(stringIntegerExtractor)
        );
